...
public class EditTeman extends AppCompatActivity {
    ...
    private static String url_update = "http://10.0.0.2/umyTI/updatetm.php";
    ...
    {
        Intent inten = new Intent(getApplicationContext(), com.example.activity8.MainActivity.class);
        startActivity(inten);
        finish();
    }
}